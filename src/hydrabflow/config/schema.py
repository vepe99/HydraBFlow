...
class TrainingConfig:
    ...
    verbose: int = 2
    # Save the best-val-loss network weights during training (BayesFlow ModelCheckpoint) and
    # restore them before persisting the final approximator, so a late-training divergence
    # (e.g. a NaN loss spike) can never destroy a converged model. Paired with a
    # TerminateOnNaN callback in train.py.
